...
?>
            ...
            <?php include_once(G5_PATH.'/_bbs_list_component/bbs_ul_reset_star.php'); ?>
...
<div id="bo_gall">
    ...
    <div id="bo_btn_top">
        ...
        <ul class="btn_bo_user">
        	<?php if ($admin_href) { ?><li><a href="<?php echo $admin_href ?>" class="btn_s1" title="관리자">관리자<span class="sound_only">admin</span></a></li><?php } ?>
            ...
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_s1" title="글쓰기">글쓰기<span class="sound_only">글쓰기</span></a></li><?php } ?>
            ...
            <div class="gall_box">
                ...
                <div class="gall_con">
                    ...
                    <div class="gall_info">
                        ...
                        <span class="gall_date"><span class="sound_only">작성일 </span>작성일 <?php echo $list[$i]['datetime2'] ?></span>
                        <span class="gall_view"><span class="sound_only">조회 </span>조회 <?php echo $list[$i]['wr_hit'] ?></span>
                    </div>
