...
<main>
            ...
            <div class="tab_content page">
                <ul class="sub_tab tab7 innertop innerbot">
                    ...
                    <li class="on"><a href="menu2_4.php">one-day 패키지</a></li>
            ...
            <div class="content page">
                <h3>
                    ...
                    <i>
                        <em ><b>one-day 패키지</b></em>
                    </i>
                </h3>
                <div class="innerbot">
                    <div class="flex_wrap m1_1 m2_1">
                        <div class="img_wrap">
                            <img src="./img/m24_1.png" alt="one-day 패키지">
                        </div>
                        <div class="txt_wrap">
                            <b data-aos="fade-up">잊지 못할 <i>첫인상 </i>남기고 싶다면? <br><i>One-Day 패키지 프로그램</i></b>
                            <div class="pinkpoint" data-aos="fade-up" data-aos-delay="100"></div>
                            <p data-aos="fade-up" data-aos-delay="200">
                                <i>리셋의 급속 반전 효과!</i><br>
                                <em><i></i>짧은 시간에 탁월한 효과를 경험하는<br>
                                리셋 원데이 패키지</em>
                            </p>
                        </div>
                    </div>
            ...
            <div class="m24_4 page">
                <div class="content innertop ">
                    <h3>
                        <span>RESET CLINIC</span>
                        <i>
                            <em ><b>One-Day 패키지 프로그램</b></em>
                        </i>
                    </h3>
                    <div class="flex_wrap">
                        <div class="img_wrap">
                            <img src="./img/m24_4.png" alt="One-Day 패키지 프로그램">
                        </div>
                        <div class="txt_wrap">
                            <ul>
                                <li data-aos="fade-up">
