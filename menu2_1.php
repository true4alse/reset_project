...
<main>
            ...
            <div class="tab_content page">
                <ul class="sub_tab tab7 innertop innerbot">
                    <li class="on"><a href="menu2_1.php">상체 패키지</a></li>
            ...
            <div class="content page">
                ...
                <div class="innerbot">
                    <div class="flex_wrap m1_1 m2_1">
                        <div class="img_wrap">
                            <img src="./img/m21_1.png" alt="상체 패키지">
                        </div>
                        <div class="txt_wrap">
                            <b data-aos="fade-up"><i>덩치값</i> 하고 싶지 않으면 <br>지금 당장  <i>리셋 하라!</i></b>
                ...
                <div class="content  ">
                    <div class="flex_wrap">
                        <div class="txt_wrap innertop innerbot">
                            ...
                            <div class="m21_4_tit" data-aos="fade-up">집중 관리 케어</div>
                        </div>
                        <div class="img_wrap">
            ...
            <div class="m21_5 page">
                <div class="content   innertop innerbot">
                    <div class="pinkbox" data-aos="fade-up">
                        <div class="pink">리셋만의 체계적인 상체관리 시스템</div>
