    ...
    <div class="list_01">
        ...
        <ul>
            ...
            <li class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
                ...
                <div class="bo_cnt">
                    <div>
                        <span>예약자 : <?php echo $list[$i]['wr_name'] ?></span>/
                        <span>연락처 : <?php echo $list[$i]['wr_subject'] ?></span>/
                        <span>희망날짜 : <?php echo $list[$i]['wr_1'] ?></span>/
                        <span>희망시간 : <?php echo $list[$i]['wr_2'] ?></span>/
                        <span>선택분류 : <?php echo $list[$i]['wr_3'] ?></span>/
                        <span>이메일 : <?php echo $list[$i]['wr_4'] ?></span>/
                        <span>생년월일 : <?php echo $list[$i]['wr_5'] ?></span>/
                        <span>구분 : <?php echo $list[$i]['wr_6'] ?></span>/
                    </div>
