...
<main>
            ...
            <div class="tab_content page">
                <ul class="sub_tab tab7 innertop innerbot">
                    ...
                    <li class="on"><a href="menu2_5.php">5주 패키지</a></li>
            ...
            <div class="content page">
                ...
                <div class="innerbot">
                    <div class="flex_wrap m1_1 m2_1">
                        <div class="img_wrap">
                            <img src="./img/m25_1.png" alt="5주 패키지">
                        </div>
                        <div class="txt_wrap">
                            <b data-aos="fade-up"><i>5주 패키지 프로그램</i><br>초고속 다이어트로<br>한달 후 <i>리셋 완성</i></b>
                            <div class="pinkpoint" data-aos="fade-up" data-aos-delay="100"></div>
                            <p data-aos="fade-up" data-aos-delay="200">
                                <i>리셋만의 5주 패키지 프로그램<br>
            ...
            <div class="page">
                <div class="content  innertop  innerbot">
                    <div class="pinkbox" data-aos="fade-up">
                        <div class="pink">다음 달에 중요한 만남, <i>지금 이 몸으로?</i></div>
                        <div><i class="pi">5주 패키지</i>로 리셋하라!</div>
                    </div>
                </div>
            </div>
        </main>
